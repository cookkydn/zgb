...
pub const Instruction = union(enum) {
    ...
    pop_r16stk: PopR16Stk,
    /// Push register r16 into the stack.
    push_r16stk: PushR16Stk,
    ...
    pub fn format(
        ...
        switch (self) {
            inline else => |instr_value| {
                const InstrType = @TypeOf(instr_value);
                if (InstrType == void) {
                    return;
                } else {
                    try writer.print(" {{", .{});
                    const fields = std.meta.fields(InstrType);
                    inline for (fields, 0..) |f, i| {
                        const comma = if (i > 0) ", " else "";
                        const val = @field(instr_value, f.name);
                        const val_type = @FieldType(InstrType, f.name);
    ...
    pub fn fromBus(bus: *Bus) Instruction {
        switch (bus.read_u8()) {
            // --- 0x00 to 0x0F ---
            0x00 => return .nop,
            ...
            0xCB => return Instruction.prefixFromBus(bus),
    ...
    pub fn prefixFromBus(bus: *Bus) Instruction {
        switch (bus.read_u8()) {
            // --- 0x00 to 0x0F ---
...
pub const R16Stk = enum {
    ...
    de,
    hl,
    pub fn readR16(value: u2) R16Stk {
        switch (value) {
            0 => return .bc,
            1 => return .de,
            2 => return .hl,
...
pub const R16Mem = enum {
    ...
    hld,
    hli,
    pub fn readR16Mem(value: u2) R16Mem {
        switch (value) {
            0 => return .bc,
            1 => return .de,
            2 => return .hli,
...
const GenericImmU8 = struct {
    imm8: u8,
};

const GenericImmI8 = struct {
    offset: i8,
};

const GenericImmU16 = struct {
    imm16: u16,
};

const GenericR8 = struct {
    r8: R8,
};

const GenericR16 = struct {
    r16: R16,
};

const GenericR16Stk = struct {
    r16stk: R16Stk,
};

const GenericR16Mem = struct {
    r16mem: R16Mem,
};

const GenericB3R8 = struct {
    bit_index: u3,
    r8: R8,
};

pub const GenericCondImm16 = struct {
    cond: Cond,
    imm16: u16,
};

pub const LdR16Imm16 = struct {
    r16: R16,
    imm16: u16,
};

pub const LdR16MemA = GenericR16Mem;
pub const LdAR16Mem = GenericR16Mem;

pub const LdImm16Sp = GenericImmU16;

pub const IncR16 = GenericR16;
pub const DecR16 = GenericR16;
pub const AddHlR16 = GenericR16;

pub const IncR8 = GenericR8;
pub const DecR8 = GenericR8;

pub const LdR8Imm8 = struct {
    r8: R8,
    imm8: u8,
};

pub const JrImm8 = GenericImmI8;

pub const JrCondImm8 = struct {
    cond: Cond,
    offset: i8,
};

pub const LdR8R8 = struct {
    r8_dst: R8,
    r8_src: R8,
};

pub const AddAR8 = GenericR8;
pub const AdcAR8 = GenericR8;
pub const SubAR8 = GenericR8;
pub const SbcAR8 = GenericR8;
pub const AndAR8 = GenericR8;
pub const XorAR8 = GenericR8;
pub const OrAR8 = GenericR8;
pub const CpAR8 = GenericR8;

pub const AddAImm8 = GenericImmU8;
pub const AdcAImm8 = GenericImmU8;
pub const SubAImm8 = GenericImmU8;
pub const SbcAImm8 = GenericImmU8;
pub const AndAImm8 = GenericImmU8;
pub const XorAImm8 = GenericImmU8;
pub const OrAImm8 = GenericImmU8;
pub const CpAImm8 = GenericImmU8;

pub const RetCond = struct {
    cond: Cond,
};

pub const JpCondImm16 = GenericCondImm16;

pub const JpImm16 = GenericImmU16;

pub const CallCondImm16 = GenericCondImm16;

pub const CallImm16 = GenericImmU16;

pub const RstTgt3 = struct {
    target_addr: u8,
};

pub const PopR16Stk = GenericR16Stk;
pub const PushR16Stk = GenericR16Stk;

pub const LdhImm8A = GenericImmU8;
pub const LdImm16A = GenericImmU16;
pub const LdhAImm8 = GenericImmU8;
pub const LdAImm16 = GenericImmU16;

pub const AddSpImm8 = GenericImmI8;
pub const LdHlSpPlusImm8 = GenericImmI8;

pub const RlcR8 = GenericR8;
pub const RrcR8 = GenericR8;
pub const RlR8 = GenericR8;
pub const RrR8 = GenericR8;
pub const SlaR8 = GenericR8;
pub const SraR8 = GenericR8;
pub const SwapR8 = GenericR8;
pub const SrlR8 = GenericR8;

pub const BitB3R8 = GenericB3R8;
pub const ResB3R8 = GenericB3R8;
pub const SetB3R8 = GenericB3R8;
